...
export function InvoiceFormPage({ variant = 'page', onClose, onSuccess }: MobileFormShellProps = {}) {
  const { id } = useParams()
  ...
  const exitAfterSave = (path: string) => {
  ...
  if (id && loadingInvoice) return <PageLoadingState layout="content" />
